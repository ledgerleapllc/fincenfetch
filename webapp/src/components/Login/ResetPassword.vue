			...
			<div class="login-box">
				...
				<div class="login-form-wrap">
					...
					<div class="form-group pt10 login-form">
						<form @submit.prevent>
							<input class="form-control fincen-input mb5" v-model="inputNewPassword1" type="password" placeholder="New Password" autofocus>
							<input class="form-control fincen-input mb5 mt20" v-model="inputNewPassword2" type="password" placeholder="Confirm Password">
